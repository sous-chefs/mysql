...
describe 'stepped into mysql_test_custom::server on amazon-2014.03' do
  let(:amazon_2014_03_custom_run) do
    ChefSpec::Runner.new(
      ...
      node.set['mysql']['service_name'] = 'amazon_2014_03_custom'
  ...
  let(:my_cnf_5_5_content_amazon_2014_03) do
  ...
  context 'when using default parameters' do
    ...
    it 'steps into mysql_service and renders file[/etc/my.cnf]' do
      expect(amazon_2014_03_custom_run).to render_file('/etc/my.cnf').with_content(my_cnf_5_5_content_amazon_2014_03)
    end

    it 'steps into mysql_service and creates bash[move mysql data to datadir]' do
      expect(amazon_2014_03_custom_run).to_not run_bash('move mysql data to datadir')
    end
