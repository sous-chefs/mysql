...
describe 'stepped into mysql_test_default::server on amazon-2014.03' do
...
'
  ...
  context 'when using default parameters' do
    ...
    it 'steps into mysql_service and renders file[/etc/my.cnf]' do
      expect(amazon_2014_03_default_run).to render_file('/etc/my.cnf').with_content(my_cnf_5_5_content_amazon_2014_03)
    end

    it 'steps into mysql_service and creates bash[move mysql data to datadir]' do
      expect(amazon_2014_03_default_run).to_not run_bash('move mysql data to datadir')
    end
