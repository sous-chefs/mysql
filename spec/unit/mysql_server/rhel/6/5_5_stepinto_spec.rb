...
describe 'stepped into mysql_test_custom::server on centos-6.4' do
  let(:centos_6_4_5_5_stepinto_run) do
    ChefSpec::Runner.new(
      ...
      node.set['mysql']['service_name'] = 'centos_6_4_5_5'
  ...
  context 'when using default parameters' do
    it 'creates mysql_service[centos_6_4_5_5]' do
      expect(centos_6_4_5_5_stepinto_run).to create_mysql_service('centos_6_4_5_5').with(
        :version => '5.5',
        :port => '3308',
        :data_dir => '/data'
        )
    ...
    it 'steps into mysql_service and installs package[mysql-server]' do
      expect(centos_6_4_5_5_stepinto_run).to install_package('mysql-community-server')
    end
    ...
    it 'steps into mysql_service and creates service[mysqld]' do
      expect(centos_6_4_5_5_stepinto_run).to start_service('mysqld')
      expect(centos_6_4_5_5_stepinto_run).to enable_service('mysqld')
    end
    ...
    it 'steps into mysql_service and creates bash[move mysql data to datadir]' do
      expect(centos_6_4_5_5_stepinto_run).to_not run_bash('move mysql data to datadir')
    end
  end
end
