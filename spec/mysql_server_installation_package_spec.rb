...
describe 'mysql_test::installation_server' do
  ...
  context 'using el5' do
    it 'installs mysql_server_installation_package[default] when version is 5.0' do
      installation_server_package_centos_5.node.set['mysql']['version'] = '5.0'
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.1' do
      installation_server_package_centos_5.node.set['mysql']['version'] = '5.1'
      installation_server_package_centos_5.converge(described_recipe)
      expect(installation_server_package_centos_5).to install_mysql_server_installation_package('default').with(
        version: '5.1',
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.5' do
      installation_server_package_centos_5.node.set['mysql']['version'] = '5.5'
      installation_server_package_centos_5.converge(described_recipe)
      expect(installation_server_package_centos_5).to install_mysql_server_installation_package('default').with(
        version: '5.5',
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.6' do
      installation_server_package_centos_5.node.set['mysql']['version'] = '5.6'
      installation_server_package_centos_5.converge(described_recipe)
      expect(installation_server_package_centos_5).to install_mysql_server_installation_package('default').with(
        version: '5.6',
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.7' do
      installation_server_package_centos_5.node.set['mysql']['version'] = '5.7'
      installation_server_package_centos_5.converge(described_recipe)
      expect(installation_server_package_centos_5).to install_mysql_server_installation_package('default').with(
        version: '5.7',
        package_name: 'mysql-community-server',
  ...
  context 'using el6' do
    it 'installs mysql_server_installation_package[default] when version is 5.1' do
      installation_server_package_centos_6.node.set['mysql']['version'] = '5.1'
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.5' do
      installation_server_package_centos_6.node.set['mysql']['version'] = '5.5'
      installation_server_package_centos_6.converge(described_recipe)
      expect(installation_server_package_centos_6).to install_mysql_server_installation_package('default').with(
        version: '5.5',
        package_name: 'mysql-community-server',
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.6' do
      installation_server_package_centos_6.node.set['mysql']['version'] = '5.6'
      installation_server_package_centos_6.converge(described_recipe)
      expect(installation_server_package_centos_6).to install_mysql_server_installation_package('default').with(
        version: '5.6',
        package_name: 'mysql-community-server',
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.7' do
      installation_server_package_centos_6.node.set['mysql']['version'] = '5.7'
      installation_server_package_centos_6.converge(described_recipe)
      expect(installation_server_package_centos_6).to install_mysql_server_installation_package('default').with(
        version: '5.7',
        package_name: 'mysql-community-server',
  ...
  context 'using el7' do
    it 'installs mysql_server_installation_package[default] when version is 5.5' do
      installation_server_package_centos_7.node.set['mysql']['version'] = '5.5'
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.6' do
      installation_server_package_centos_7.node.set['mysql']['version'] = '5.6'
      installation_server_package_centos_7.converge(described_recipe)
      expect(installation_server_package_centos_7).to install_mysql_server_installation_package('default').with(
        version: '5.6',
        package_name: 'mysql-community-server',
    ...
    it 'installs mysql_server_installation_package[default] when version is 5.7' do
      installation_server_package_centos_7.node.set['mysql']['version'] = '5.7'
      installation_server_package_centos_7.converge(described_recipe)
      expect(installation_server_package_centos_7).to install_mysql_server_installation_package('default').with(
        version: '5.7',
        package_name: 'mysql-community-server',
  ...
  context 'using ubuntu 16.04' do
    it 'installs mysql_server_installation_package[default] when version is 5.7' do
      ...
      expect(installation_server_package_ubuntu_1604).to install_mysql_server_installation_package('default').with(
        ...
        package_version: '5.7.13-0ubuntu0.16.04.2'
      )
    end
  end
end
