...
describe 'mysql_service_test::single on centos-5.11' do
  cached(:centos_511_service_57_single) do
  ...
  context 'compiling the test recipe' do
    it 'creates mysql_service[default]' do
      expect(centos_511_service_57_single).to create_mysql_service('default')
    end
  end
  ...
  context 'stepping into mysql_service[default] resource' do
    it 'installs package[default :create mysql-community-server]' do
      expect(centos_511_service_57_single).to install_package('default :create mysql-community-server')
        .with(package_name: 'mysql-community-server', version: nil)
    end

    it 'stops service[default :create mysqld]' do
      expect(centos_511_service_57_single).to disable_service('default :create mysqld')
      expect(centos_511_service_57_single).to stop_service('default :create mysqld')
    end

    it 'creates group[default :create mysql]' do
      expect(centos_511_service_57_single).to create_group('default :create mysql')
        .with(group_name: 'mysql')
    end

    it 'creates user[default :create mysql]' do
      expect(centos_511_service_57_single).to create_user('default :create mysql')
        .with(username: 'mysql')
    end

    it 'deletes file[default :create /etc/mysql/my.cnf]' do
      expect(centos_511_service_57_single).to delete_file('default :create /etc/mysql/my.cnf')
        .with(path: '/etc/mysql/my.cnf')
    end

    it 'deletes file[default :create /etc/my.cnf]' do
      expect(centos_511_service_57_single).to delete_file('default :create /etc/my.cnf')
        .with(path: '/etc/my.cnf')
    end

    it 'creates link[default :create /usr/share/my-default.cnf]' do
      expect(centos_511_service_57_single).to create_link('default :create /usr/share/my-default.cnf')
        .with(
    ...
    it 'creates directory[default :create /etc/mysql-default]' do
      expect(centos_511_service_57_single).to create_directory('default :create /etc/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /etc/mysql-default/conf.d]' do
      expect(centos_511_service_57_single).to create_directory('default :create /etc/mysql-default/conf.d')
        .with(
    ...
    it 'creates directory[default :create /var/run/mysql-default]' do
      expect(centos_511_service_57_single).to create_directory('default :create /var/run/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /var/log/mysql-default]' do
      expect(centos_511_service_57_single).to create_directory('default :create /var/log/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /var/lib/mysql-default]' do
      expect(centos_511_service_57_single).to create_directory('default :create /var/lib/mysql-default')
        .with(
    ...
    it 'creates template[default :create /etc/mysql-default/my.cnf]' do
      expect(centos_511_service_57_single).to create_template('default :create /etc/mysql-default/my.cnf')
        .with(
    ...
    it 'runs bash[default :create initialize mysql database]' do
      expect(centos_511_service_57_single).to_not run_bash('default :create initialize mysql database')
        .with(
    ...
    it 'runs bash[default :create initial records]' do
      expect(centos_511_service_57_single).to_not run_bash('default :create initial records')
    end

    it 'create template[default :start /etc/init.d/mysql-default]' do
      expect(centos_511_service_57_single).to create_template('default :start /etc/init.d/mysql-default')
        .with(
    ...
    it 'starts service[default :start mysql-default]' do
      expect(centos_511_service_57_single).to start_service('default :start mysql-default')
        .with(
