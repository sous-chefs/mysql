...
describe 'mysql_service_test::single on centos-7.0' do
  ...
  context 'stepping into mysql_service[instance-1] resource' do
    ...
    it 'create template[instance-1 :start /lib/systemd/system/mysql-instance-1.service]' do
      expect(centos_70_service_56_multi).to create_template('instance-1 :start /lib/systemd/system/mysql-instance-1.service')
        .with(
  ...
  context 'stepping into mysql_service[instance-2] resource' do
    ...
    it 'create template[instance-2 :start /lib/systemd/system/mysql-instance-2.service]' do
      expect(centos_70_service_56_multi).to create_template('instance-2 :start /lib/systemd/system/mysql-instance-2.service')
        .with(
