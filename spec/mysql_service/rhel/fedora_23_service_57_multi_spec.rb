...
describe 'mysql_service_test::single on fedora-23' do
  ...
  context 'stepping into mysql_service[instance-1] resource' do
    ...
    it 'creates template[instance-1 :start /etc/systemd/system/mysql-instance-1.service]' do
      expect(fedora_23_service_57_multi).to create_template('instance-1 :start /etc/systemd/system/mysql-instance-1.service')
        .with(
  ...
  context 'stepping into mysql_service[instance-2] resource' do
    ...
    it 'creates template[instance-2 :start /etc/systemd/system/mysql-instance-2.service]' do
      expect(fedora_23_service_57_multi).to create_template('instance-2 :start /etc/systemd/system/mysql-instance-2.service')
        .with(
