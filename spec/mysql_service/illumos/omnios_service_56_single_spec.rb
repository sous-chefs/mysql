...
describe 'mysql_service_test::single on omnios-151014' do
  cached(:omnios_service_56_single) do
  ...
  context 'compiling the test recipe' do
    it 'creates mysql_service[default]' do
      expect(omnios_service_56_single).to create_mysql_service('default')
    end
  end
  ...
  context 'stepping into mysql_service[default] resource' do
    it 'installs package[default :create database/mysql-56]' do
      expect(omnios_service_56_single).to install_package('default :create database/mysql-56')
        .with(package_name: 'database/mysql-56', version: nil)
    end

    it 'creates group[default :create mysql]' do
      expect(omnios_service_56_single).to create_group('default :create mysql')
        .with(group_name: 'mysql')
    end

    it 'creates user[default :create mysql]' do
      expect(omnios_service_56_single).to create_user('default :create mysql')
        .with(username: 'mysql')
    end

    it 'deletes file[default :create /opt/mysql56/etc/mysql/my.cnf]' do
      expect(omnios_service_56_single).to delete_file('default :create /opt/mysql56/etc/mysql/my.cnf')
        .with(path: '/opt/mysql56/etc/mysql/my.cnf')
    end

    it 'deletes file[default :create /opt/mysql56/etc/my.cnf]' do
      expect(omnios_service_56_single).to delete_file('default :create /opt/mysql56/etc/my.cnf')
        .with(path: '/opt/mysql56/etc/my.cnf')
    end

    it 'creates link[default :create /opt/mysql56/usr/share/my-default.cnf]' do
      expect(omnios_service_56_single).to create_link('default :create /opt/mysql56/usr/share/my-default.cnf')
        .with(
    ...
    it 'creates directory[default :create /opt/mysql56/etc/mysql-default]' do
      expect(omnios_service_56_single).to create_directory('default :create /opt/mysql56/etc/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /opt/mysql56/etc/mysql-default/conf.d]' do
      expect(omnios_service_56_single).to create_directory('default :create /opt/mysql56/etc/mysql-default/conf.d')
        .with(
    ...
    it 'creates directory[default :create /var/run/mysql-default]' do
      expect(omnios_service_56_single).to create_directory('default :create /var/run/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /var/adm/log/mysql-default]' do
      expect(omnios_service_56_single).to create_directory('default :create /var/adm/log/mysql-default')
        .with(
    ...
    it 'creates directory[default :create /opt/local/lib/mysql-default]' do
      expect(omnios_service_56_single).to create_directory('default :create /opt/local/lib/mysql-default')
        .with(
    ...
    it 'creates template[default :create /opt/mysql56/etc/mysql-default/my.cnf]' do
      expect(omnios_service_56_single).to create_template('default :create /opt/mysql56/etc/mysql-default/my.cnf')
        .with(
    ...
    it 'runs bash[default :create initialize mysql database]' do
      expect(omnios_service_56_single).to_not run_bash('default :create initialize mysql database')
        .with(
    ...
    it 'runs bash[default :create initial records]' do
      expect(omnios_service_56_single).to_not run_bash('default :create initial records')
    end

    it 'create template[default :start /lib/svc/method/mysql-default]' do
      expect(omnios_service_56_single).to create_template('default :start /lib/svc/method/mysql-default')
        .with(
    ...
    it 'create template[default :start /lib/svc/method/mysql-default]' do
      expect(omnios_service_56_single).to install_smf('mysql-default')
        .with(
          name: 'mysql-default',
          user: 'mysql',
          group: 'mysql',
    ...
    it 'starts service[default :start mysql-default]' do
      expect(omnios_service_56_single).to enable_service('default :start mysql-default')
        .with(
