...
if Chef::Config[:solo]
  ...
  node['mysql']['server_debian_password'] = secure_password unless node['mysql']['server_debian_password']
  node['mysql']['server_root_password']   = secure_password unless node['mysql']['server_root_password']
  node['mysql']['server_repl_password']   = secure_password unless node['mysql']['server_repl_password']
  node.save
end
