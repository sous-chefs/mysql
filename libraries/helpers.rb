...
EOSQL
    ...
    class Pkginfo
      def self.pkginfo
        ...
        @pkginfo.set['rhel']['2014.03']['5.1']['server_package'] = %w(mysql51 mysql51-devel)
        @pkginfo.set['rhel']['2014.03']['5.1']['server_package'] = 'mysql51-server'
        @pkginfo.set['rhel']['2014.03']['5.5']['client_package'] = %w(mysql-community-client mysql-community-devel)
        @pkginfo.set['rhel']['2014.03']['5.5']['server_package'] = 'mysql-community-server'
        @pkginfo.set['rhel']['2014.03']['5.6']['client_package'] = %w(mysql-community-client mysql-community-devel)
        @pkginfo.set['rhel']['2014.03']['5.6']['server_package'] = 'mysql-community-server'
        @pkginfo.set['rhel']['2014.03']['5.7']['client_package'] = %w(mysql-community-client mysql-community-devel)
        @pkginfo.set['rhel']['2014.03']['5.7']['server_package'] = 'mysql-community-server'
