...
# Set the client : mysql / percona / percona-cluster
default['mysql']['client']['type'] = "none"
...
when 'debian'
	...
	when 'percona'
		default['mysql']['client']['packages'] = %w[percona-server-client-5.5 libmysqlclient18 libmysqlclient18-dev]
	when 'percona-cluster'
		default['mysql']['client']['packages'] = %w[percona-xtradb-cluster-client-5.5 libmysqlclient18 libmysqlclient18-dev]
	end
when 'freebsd'
